...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list.add(Drama("Титанік", "Драма", "У фільмі «Титанік» йшов з гавані в свій єдиний рейс корабель, зроблений з сучасним досягненням техніки. Його " +
                "вважали непотоплюваним. Велетень взяв на свій борт аристократів зі слугами, багатіїв-промисловців і бідняків-" +
                "іммігрантів. У кінокартині одночасно розвиваються дві паралельні любовні лінії. У першому класі і в третьому.", R.drawable.titanic))
        list.add(Fight("Термінатор", "Бойовик", "Історія протистояння солдата Кайла Різа і кіборга-термінатора, прибулих в 1984-й рік з " +
                ...
                "врятувати Сару і зупинити Термінатора будь-що.", R.drawable.terminator))
        list.add(Fantasy("Чорний Адам", "Фентезі", "Сюжет обертається довкола легендарного антигероя Чорного Адама. Провівши понад 5000 років у в'язниці, " +
                ...
                "передавши свої сили стародавньому чаклунові, чи він знову зазнає поразки від прихильників Ліги справедливості?", R.drawable.adam))
        list.add(Fight("Космічна Одіссея", "Драма", "Капітани зорельота Дейв і Френк отримують відповідальне завдання — дослідити " +
                ...
                "несподіванок." , R.drawable.odissey))
